...
pmpt2 = """
Dans le schéma JSON fourni, complète avec les axes sémantiques que tu identifies et les termes de la disjonction. 
Rends uniquement le JSON. N’ajoute pas de balisage ```json. 
N’ajoute aucun autre commentaire ou résumé en dehors du JSON. 
Si tu ne trouves pas de disjonctions, explique-le dans le champ explication. 
"""


txt = pmp1 + text_to_analyze + pmpt2

# Then, you can use the `txt` variable for model inference.
